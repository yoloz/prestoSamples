...
public class QueryBuilder {
    ...
    public PreparedStatement buildSql(ExtractClient client, Connection connection, String catalog,
                                      String schema, String table, List<ExtractColumnHandle> columns,
                                      TupleDomain<ColumnHandle> tupleDomain)
            throws SQLException {
        StringBuilder sql = new StringBuilder();

        String columnNames = columns.stream()
                .map(ExtractColumnHandle::getColumnName)
                .map(this::quote)
                .collect(joining(", "));
        ...
        log.info("execute sql is: %s", sql.toString());
    ...
    private List<String> toConjuncts(List<ExtractColumnHandle> columns, TupleDomain<ColumnHandle> tupleDomain, List<TypeAndValue> accumulator) {
        ImmutableList.Builder<String> builder = ImmutableList.builder();
        for (ExtractColumnHandle column : columns) {
